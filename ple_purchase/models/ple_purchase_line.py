...
class PlePurchaseLine(models.Model):
    ...
    number_origin = fields.Char(string=u'Número Origen')
    ...
    inv_correlative = fields.Char(string=u'Correlativo de Comprobante')
    inv_year_dua_dsi = fields.Char(string=u'Año emisión  DUA o DSI')
    inv_retention_igv = fields.Float(string=u'Monto retención de IGV')
    ...
    application_article = fields.Char(string=u'Aplicación Art. 76°')
