...
class AccountMove(models.Model):
    ...
    not_domiciled_purchase_move_period = fields.Selection([
        ...
        ('1', 'Ajuste o rectificación en la anotación de la información de una operación registrada en un periodo anterior.')
    ], string='Estado de factura de compra no domiciliado', default='1')
