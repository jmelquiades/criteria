...
class AccountPayment(models.Model):
    ...
    def _prepare_move_line_default_vals(self, write_off_line_vals=None):
        ...
        liquidity_amount_currency, liquidity_balance, write_off_balance,  counterpart_amount_currency, counterpart_balance, currency_id = self._prepare_vals_debit_credit_amount_currency(write_off_amount_currency)
